...
\[
\text{Cost}_{\lambda} \approx \$1.67 + \$5.23 = \$6.90/\text{month}
\]
...
\[
R = \frac{14.98}{8.25\times 10^{-7} \cdot 2\,592\,000} \approx 7.0\ \text{RPS}
\]
...
The recommendation draws on the monthly cost estimates in this section, the break-even RPS (~8.3 vs Fargate, ~7.0 vs EC2), and the p99 values from the Scenario B and C tables.
